...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.soomcoin
    BOOST_LIB_SUFFIX=-mt
...
contains(SOOMCOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += SOOMCOIN_NEED_QT_PLUGINS
...
HEADERS += \
    ...
    src/qt/soomcoingui.h \
    src/qt/soomcoinbridge.h \
...
SOURCES += \
    ...
    src/qt/soomcoingui.cpp \
    src/qt/soomcoin.cpp \
    src/qt/soomcoinbridge.cpp
...
# also add new translations to soomcoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/soomcoin*.ts)
...
macx:ICON = src/qt/res/icons/soomcoin.icns
macx:TARGET = "Soomcoin"
