...
/**
  Sumcoin GUI main class. This class represents the main window of the Sumcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SumcoinGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit SumcoinGUI(QWidget *parent = 0);
    ~SumcoinGUI();
