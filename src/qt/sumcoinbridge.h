#ifndef SUMCOINBRIDGE_H
#define SUMCOINBRIDGE_H
...
class SumcoinBridge : public QObject
{
    Q_OBJECT
...
public:
    explicit SumcoinBridge(SumcoinGUI *window, QObject *parent = 0);
    ~SumcoinBridge();
