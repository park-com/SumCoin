...
#ifndef SOOMCOINGUI_H
#define SOOMCOINGUI_H
...
/**
  Soomcoin GUI main class. This class represents the main window of the Soomcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SoomcoinGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit SoomcoinGUI(QWidget *parent = 0);
    ~SoomcoinGUI();
