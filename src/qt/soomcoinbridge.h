#ifndef SOOMCOINBRIDGE_H
#define SOOMCOINBRIDGE_H
...
class SoomcoinBridge : public QObject
{
    Q_OBJECT
...
public:
    explicit SoomcoinBridge(SoomcoinGUI *window, QObject *parent = 0);
    ~SoomcoinBridge();
