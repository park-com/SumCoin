...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.sumcoin
    BOOST_LIB_SUFFIX=-mt
...
contains(SUMCOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += SUMCOIN_NEED_QT_PLUGINS
...
SOURCES += \
    ...
    src/qt/sumcoingui.cpp \
    src/qt/sumcoin.cpp \
    src/qt/sumcoinbridge.cpp
...
# also add new translations to sumcoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/sumcoin*.ts)
